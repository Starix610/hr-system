...
<div class="col-md-10 mian_cont" style="width: 100%">
    <form class="form-panel" id="recheckForm" style="background-color: #f0f0f6" action="javascript:void(0)" >
        <div>
            <h1 style="margin-left: 30px;margin-top: 10px">档案详情</h1>
        </div>
        <div class="flex_li">
        ...
        <div class="flex_ul">
            ...
            <div class="flex_li">
                ...
                <div>
                    <input type="text" name="recheckName" value="${staffRecord.recheckName}">
                </div>
            </div>
            <div class="flex_li">
                <div class="form_text">复核时间</div>
                <div>
                    <input type="text"disabled="true" name="recheckTime"
                           value="<fmt:formatDate value='${staffRecord.recheckTime}' pattern='yyyy-MM-dd HH:mm:ss'/>"/>
                </div>
            </div>
            <div class="flex_li">
