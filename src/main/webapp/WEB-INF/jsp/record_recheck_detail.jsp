...
<div class="col-md-10 mian_cont" style="width: 100%">
    <form class="form-panel" id="recheckForm" style="background-color: #f0f0f6" action="javascript:void(0)" >
        <div>
            <h1 style="margin-left: 30px;margin-top: 10px">档案复核</h1>
        </div>
        <div class="flex_li">
        ...
        <div class="flex_ul">
            ...
            <div class="flex_li">
                <div class="form_text">复核人</div>
                <div>
                    <input type="text" name="recheckName" value="<security:authentication property="principal.username"></security:authentication>">
                </div>
            </div>
            <div class="flex_li">
                <div class="form_text">复核时间</div>
                <div>
                    <input type="text"disabled="true" id="recheckTime" name="recheckTime"/>
                </div>
            </div>
            <div class="flex_li">
...
<script>
    ...
    $(function () {
        ...
        //ajax提交表单
        $("#recheckForm").submit(function () {
            $("input[name='recheckTime']").removeAttr("disabled");//关闭禁用，否则该项无法提交
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/staffs/recheck/${staffRecord.recordId}",
                processData:false,
                contentType:false,
                data: new FormData(document.getElementById("recheckForm")),
                dataType: "json",
                success: function(data){
                    //成功之后的操作，页面跳转
                    // alert(data.data);
                    var message = "员工档案复核成功！";
                    var back = "${pageContext.request.contextPath}/staffs/recheck/list";
