...
<div style="width: auto;">
    ...
    <ul>
        ...
        <li class="flex_li">
            ...
            <div id="realPay">${detailMap.get("paymentQueryResult").totalBaseSalary}</div>
        </li>
        <li class="flex_li">
        ...
        <li class="flex_li">
            <div style="position: absolute;top: 42%;left: 79%;">
                <input id="submit1" type="button" value="提交" class="btn btn-success">
            </div>
        </li>
    </ul>
                    ...
                    <table  class="table table-hover">
                        ...
                        <c:forEach items="${detailMap.detailList}" var="detail">
                            <tr class="active">
                                ...
                                <td><input type="text" onkeyup="calculateTotal()" class="form-control" style="width: 100px;" name="inputNumAdd" id="${detail.recordId}Add"></td>
                                <td><input type="text" onkeyup="calculateTotal()" class="form-control" style="width: 100px;" name="inputNumSub" id="${detail.recordId}Sub"></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
        ...
        $("#submit1").click(function () {
            ...
            var jsonData = {
                "salaryPayment":{
                    ...
                    "registrant":"<security:authentication property='principal.username'></security:authentication>",
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/salary/payment/register",
                data: JSON.stringify(jsonData),
                dataType: "json",
                success: function(data){
                    var message = "薪酬发放单提交成功！等待薪酬经理复核。";
                    var back = "${pageContext.request.contextPath}/salary/payment/register/list";//信息提示页面的返回url
                ...
                error: function (data) {
                    var message = "薪酬发放单提交失败，请稍后重试！";
                    var back = "${pageContext.request.contextPath}/salary/payment/register/list";
